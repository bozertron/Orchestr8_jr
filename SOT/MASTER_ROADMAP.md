...
> Use `SOT/CODEBASE_ROADMAP_CANONICAL.md` for current codebase-by-codebase execution.
> Use `SOT/CODE_CITY_AGGREGATED_TODO.md` for the active Code City queue.
> This file remains valuable as historical context, but is no longer the primary execution queue.
