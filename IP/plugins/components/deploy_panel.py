...
BG_OBSIDIAN = "#050505"  # Panel background - HERD 2
GOLD_DARK = "#C5A028"  # Borders - HERD 2
GOLD_LIGHT = "#F4C430"  # Lock icon (locked) - HERD 2
TEXT_GREY = "#CCC"  # Body text - HERD 2
STATE_WORKING = "#D4AF37"  # Header - HERD 2
FONT_DATA = "'VT323', monospace"  # Data text - HERD 2
...
# Using VISUAL TOKEN LOCK values (HERD 2)
DEPLOY_PANEL_CSS = f"""
<style>
