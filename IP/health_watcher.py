...
TODO: HealthWatcherManager exists but is not used in 06_maestro.py
      Only simple HealthWatcher is instantiated. Consider integrating
      HealthWatcherManager for better Marimo state integration or remove.
TODO: Default watch_paths=["IP/"] may miss other fiefdoms - consider
      making configurable to watch entire project.
"""
