...
MERMAID_CLASSDEFS = """
    ...
    classDef normal fill:#D4AF37,stroke:#B8860B,color:#0A0A0B
    classDef warning fill:#D4AF37,stroke:#B8860B,color:#0A0A0B
    classDef complex fill:#9D4EDD,stroke:#9D4EDD,color:#fff
    classDef error fill:#1fbdea,stroke:#1fbdea,color:#0A0A0B
