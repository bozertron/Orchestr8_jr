...
## Active Lane Model (2026-02-15 Refresh)

1. `Orchestr8_jr`: canonical UI/contract authority and promotion gates.
2. `a_codex_plan`: marimo-first core integration lane.
3. `2ndFid_explorers`: line-by-line extraction/conversion proposal lane.

Sequencing lock:
- Core acceptance first.
- Compliance/packaging lane starts only after core is explicitly approved.
